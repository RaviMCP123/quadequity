...
import { FormValues, UserState } from "interface/user";
...
const UserInfoCard: React.FC<UserInfoCardProps> = ({ user, refetch }) => {
          ...
          <Form onSubmit={handleSubmit(onSubmit)} className="flex flex-col">
            <div className="px-2 overflow-y-auto custom-scrollbar">
              <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                <Form.Group className="col-span-2 lg:col-span-1">
                  <Label>
                  ...
                  <Form.Control
                    ...
                    {...register("email", {
                      ...
                      maxLength: {
                        value: 50,
                        message:
                          "Email address should not exceed 50 characters.",
                      },
                      validate: {
                        noEdgeSpaces: (value) =>
                          value.trim() === value ||
                    ...
                    {...register("mobile_number", {
                      ...
                      validate: {
                        noEdgeSpaces: (value) =>
                          ...
                          "No leading or trailing spaces allowed.",
                        validLength: (value) =>
                          /^\d{8,15}$/.test(String(value)) ||
                          "Please provide 8 to 15 digit mobile number.",
                      },
                    })}
                    isInvalid={!!errors.mobile_number}
                    placeholder="Please enter mobile number"
                  />
                  <Message message={errors?.mobile_number?.message ?? ""} />
                </Form.Group>
              </div>
            </div>
